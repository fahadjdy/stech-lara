              ...
              <div class="row gy-4">
                <div class="col-lg-5">
                  <div class="profile d-flex align-items-center gap-3">
                      ...
                      <div>
                          <h4 class="profile-name">Tayyab Badhra</h4>
          ...
          <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
            <div class="image-wrapper">
              <div class="images position-relative" data-aos="zoom-out" data-aos-delay="400">
                <img src="{{ asset('user/img/about-5.jpg') }}" style="transform: scaleX(-1);" alt="Business Meeting" class="img-fluid main-image rounded-4">
                <img src="{{ asset('user/img/about-2.jpg') }}" alt="Team Discussion" class="img-fluid small-image rounded-4">
              </div>
